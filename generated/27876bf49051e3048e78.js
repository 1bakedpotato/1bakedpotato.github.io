"use strict";
(self["webpackChunkalt1cache"] = self["webpackChunkalt1cache"] || []).push([["vendors-node_modules_sqlite_org_sqlite-wasm_dist_sqlite3-worker1_mjs"],{
...
async function sqlite3InitModule(moduleArg = {}) {
	...
	*/
	(function(Module) {
		...
		*/
		Module["locateFile"] = function(path, prefix) {
			...
			return __webpack_require__("./node_modules/@sqlite.org/sqlite-wasm/dist sync recursive")(path).href;
		}.bind(sIMS);
		/**
	...
	var _scriptName = "file:///X:/Temp/RSWiki/gitlab/rsmv/node_modules/@sqlite.org/sqlite-wasm/dist/sqlite3-worker1.mjs";
	var scriptDirectory = "";
				...
				*/
				opfsVfs.bindVfs = function(ioMethods, callback) {
					...
					return new Promise(function(promiseResolve_, promiseReject_) {
						...
						const W = opfsVfs.worker = new Worker(__webpack_require__("./node_modules/@sqlite.org/sqlite-wasm/dist sync recursive")(proxyUri));
